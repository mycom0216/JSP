UTF-8<%@page import="com.smhrd.model.MessageDTO"%>
...
<html>
	...
	<%
		// 1. session 영역 안에 저장되어있는 사용자 정보 가져오기
						...
						<ul class="actions vertical">
							<li><h5>회원정보수정</h5></li>
								<form action="UpdateProgram" method="post">
									...
									<li><input name="phone" type="text" placeholder="전화번호를 입력하세요" style="width: 500px; margin: 0 auto;"></li>
